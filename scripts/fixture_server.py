...
Pair with DOVER_JOBS_PATH=src/allocation_agent/fixtures/local-fixture-jobs.json
to exercise node_agent/apply.mjs's multi-signal success detection end-to-end.
"""
